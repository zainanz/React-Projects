        ...
        <div className="flex justify-between">
          ...
          <div style={{ width: "55%" }} className="">
            ...
            <span
              ...
              style={{ width: "10%" }}
            >
              ~ A dedicated web developer with a passion for crafting responsive
            ...
            <div className="fade-in text-2xl flex flex-col w-full ">
              ...
              >
                {" "}
                HTML, CSS, Javascript, Typescript, SCSS, TailwindCSS, Bootstrap,
                React, Redux, PostgreSQL/MySQL, Heroku and Ruby on Rails.
              </span>
            </div>
          </div>
          ...
          >
            <div style={{ width: "30rem" }}>
              ...
              <p className="px-3">
                Feel free to download my resume and contact me to discuss how I
